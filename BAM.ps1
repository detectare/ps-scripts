...
Write-Host "";
Write-Host "";
Write-Host -ForegroundColor Red "[BAM Scanner]";
Write-Host "";
Write-Host -ForegroundColor Blue "Made by @detectare" -NoNewLine
Write-Host ""
Write-Host "";
...
$Bam = Foreach ($Sid in $Users){$u++
        ...
        foreach($rp in $rpath){
           ...
           Write-Host -ForegroundColor Red "Scanning " -NoNewLine
